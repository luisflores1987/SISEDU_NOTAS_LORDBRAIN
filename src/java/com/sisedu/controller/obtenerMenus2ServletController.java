 ...
 * @author MAQ
 */
@WebServlet(name = "obtenerMenus2ServletController", urlPatterns = {"/Formularios/obtenerMenus2ServletController"})
public class obtenerMenus2ServletController extends HttpServlet {
