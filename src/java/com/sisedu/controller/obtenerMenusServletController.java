 ...
 * @author MAQ
 */
@WebServlet(name = "obtenerMenusServletController", urlPatterns = {"/obtenerMenusServletController"})
public class obtenerMenusServletController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            int nAcceso = Integer.valueOf(request.getParameter("acceso"));
