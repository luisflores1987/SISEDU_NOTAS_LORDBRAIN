 ...
 * @author MAQ
 */
@WebServlet(name = "registroMatriculaServletController", urlPatterns = {"/Formularios/registroMatriculaServletController"})
public class registroMatriculaServletController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equals("ingresarDatosMatricula")) {
...
//        }               
    ...
    private void obtenerNivel(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        List<Nivel> listaNivel = registroPension.obtenerNivelMatricula(sAñoAcademico);
    ...
    private void rowclick(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        String sAñoAcademico = request.getParameter("anioAcademico") == null ? "" : request.getParameter("anioAcademico");
        List<Grado> listGrado = registroPension.obtenerGradoMatricula(sdescripcionNivel, sAñoAcademico);
    ...
    private void consultaDatos(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        List<Alumno> listaAlumno = registroPension.consultaDatosAlumnosMatricula(paciente, nIdNivel, sAñoAcademico);
        StringBuilder sb = new StringBuilder("");
    ...
    public void ingresarDatosMatricula(HttpServletRequest request, HttpServletResponse response) throws ParseException, IOException {
        String sMensaje = "";
        ...
        String sAñoAcademico = request.getParameter("anioAcademico") == null ? "" : request.getParameter("anioAcademico");
        sMensaje = registroPension.ingresarPensionesMatricula(nIdNivel, nIdGrado, nIdPersona, sPension, nIdPersonaDeuda, sAñoAcademico);
        response.setContentType("text/plain");
        PrintWriter out = response.getWriter();
        out.print(sMensaje);
    }
...
//    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(registroMatriculaServletController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
