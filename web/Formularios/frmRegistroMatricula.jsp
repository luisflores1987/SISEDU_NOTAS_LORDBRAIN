...
<html>
    ...
    <div id="page">
        ...
        <div id="content" align="center">
            ...
            <fieldset>
                <legend>INGRESO DE MATRICULA</legend>
    ...
    <div id="pensionAlumno" title="Ingresar Pension Por Alumno">
        <form class="formulariodemo cf">
            ...
            <button id="btnBuscarInicial" type="submit" style="height: 30px;">Buscar</button>
            <button id="btnBuscarPrimaria" type="submit" style="height: 30px;">Buscar</button>
            <button id="btnBuscarSecundaria" type="submit" style="height: 30px;">Buscar</button>
        </form>
    ...
    <div id="pensionGrado" title="Ingresar Pension Por Grado">
        ...
        <button type="button" id="btnGrado" style="height:24px;width:100px;">INGRESAR</button>
</div> 
