$(document).ready(function(){
    ...
    $("#AñoAcademico  select").click(function(){
        fnCargarNiveles();
        $("#tblNiveles").show();
        $(".pensionBtn").show();
    });
        ...
        `                                </tr>'+
            ...
            $('#tblNiveles tr td input[type=text]').each(function(e){
                $('#btnNivel').on("click", function(){ 
                    ...
                    ingresarPension($('#tblNiveles tr td:nth-child(5) span').eq(e).text().trim(), 0, 0,  $('#tblNiveles tr td:nth-child(3) input').eq(e).val().trim(), 0); 
                    $('#trINICIAL').hide(500);
                    $('#trPRIMARIA').hide(500);
        ...
        if(data == '')
            ...
            $('#tblGrado tr td input').each(function(e){
                $('#btnGrado').on("click", function(){ 
                    ingresarPension(0, $('#tblGrado tr td:nth-child(4) span').eq(e).text(), 0,  $('#tblGrado tr td:nth-child(2) input').eq(e).val(), 0);                                
                })                
            })            
        }
...
function fnPensionAlumno(i, nIdPersona){
    $('#btnPersona' + nIdPersona).on("click", function(){ 
        ingresarPension(0, 0, $('#tblAlumnoPension tr td:nth-child(6) span').eq(i).text(),  $('#tblAlumnoPension tr td:nth-child(3) input').eq(i).val(), 0);                                
    });    
}

function fnPensionAlumnoDetalle(i, nIdPersonaDeuda){
    $('#btnMes' + nIdPersonaDeuda).on("click", function(){ 
        ingresarPension(0, 0, 0, $('#tblPagosMes tr td:nth-child(2) input').eq(i).val(), $('#tblPagosMes tr td:nth-child(4) span').eq(i).text());                                
    });    
}
