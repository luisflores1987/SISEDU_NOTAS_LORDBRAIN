...
function fneventoBotonGrado()
{
    $('#impresionGrado').click(function(){
            ...
            fnReporteNotasGrado($('#cboBimestre').val(), $('#cboGrado').val(),$('#spNivel').text());
    });
}

function fnReporteNotasGrado(nIdBimestre, nIdGrado, idNivel)
{
    document.location.href='impresionReporteServletController?action=reporteGrado&IdNivel='+idNivel+'&IdGrado=' + nIdGrado + '&IdBimestre=' + nIdBimestre;
}
